...
use recipe::{
  ...
  render_result_selection_candidate_cases, render_result_selection_candidate_recipe,
  render_search_entry_candidate_cases, render_search_entry_candidate_recipe,
