...
//!
//! Implements operations like `window.observeRegion`: capture a resolved
...
use super::super::{
  DriverCall, DriverResponse, ObservedOcrRow, ObservedRect, ProducedArtifact, ScreenshotDimensions,
};
