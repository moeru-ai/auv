...
pub use types::{
  BoundingBox, ClassLabelSource, Detection, DetectionCoordinateSpace, DetectionEvidenceManifest, DetectionOptions, DetectionSet, ImageFrame,
  ImageSize, ModelConfig, ModelId, ModelRunMetadata, ProjectionBasis, SourceImageEvidence, SourceImageRef,
};
