...
pub(crate) mod ffi {
  ...
  extern "Swift" {
    ...
    fn press_keys_foreground(key_codes: Vec<i32>, hold_ns: u64) -> NativeActionResponse;
    fn press_keys_in_window(pid: i64, window_number: i64, key_codes: Vec<i32>, hold_ns: u64) -> NativeActionResponse;
