...
pub use training_result_holdout_preview::{
  HoldoutFrameSelection, HoldoutFrameWitness, HoldoutPreviewAnswer, HoldoutPreviewReason, HoldoutPreviewRequest, HoldoutPreviewStatus,
...
pub use training_result_holdout_render_quality::{
  ...
  HoldoutRenderQualityReason, HoldoutRenderQualityRequest, HoldoutRenderQualityStatus, HoldoutRenderQualityVerdict,
  MC17_V1_HOLDOUT_RENDER_QUALITY_KNOWN_LIMIT, TRAINING_RESULT_HOLDOUT_RENDER_QUALITY_INSPECT_REPORT_SCHEMA_VERSION,
  TRAINING_RESULT_HOLDOUT_RENDER_QUALITY_MANIFEST_SCHEMA_VERSION, TrainingResultHoldoutRenderQualityInputs,
  TrainingResultHoldoutRenderQualityInspectReport, TrainingResultHoldoutRenderQualityManifest, TrainingResultHoldoutRenderQualityOutput,
...
pub use training_result_semantic::{
  ...
  TrainingResultSemanticStatus, TrainingResultSemanticValidationInputs, TrainingResultSemanticValidationOutput,
