//! Minecraft inspect text fragments (legacy byte-stable headers).

use std::collections::BTreeSet;

use super::helpers::{
  format_quality_verdict_line, holdout_preview_manifest_matches_report, holdout_render_quality_manifest_matches_report,
  render_minecraft_projected_point, render_projection_visibility, render_training_compatibility_status,
  spatial_query_manifest_matches_report, unique_matching_report,
};
use crate::run_read::*;
