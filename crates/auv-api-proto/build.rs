...
fn main() -> Result<(), Box<dyn std::error::Error>> {
  ...
  tonic_prost_build::configure().file_descriptor_set_path(out_dir.join("auv.api.bin")).compile_protos(
    &[
      "../../proto/auv/api/core/v1/discovery.proto",
      "../../proto/auv/api/core/v1/device.proto",
      "../../proto/auv/api/annotations/v1/annotations.proto",
      "../../proto/auv/api/core/v1/run.proto",
      "../../proto/auv/api/core/v1/runner.proto",
      "../../proto/auv/api/runner/v1/runtime.proto",
  ...
  println!("cargo:rerun-if-changed=../../proto/auv/api/core/v1/discovery.proto");
  println!("cargo:rerun-if-changed=../../proto/auv/api/core/v1/device.proto");
  println!("cargo:rerun-if-changed=../../proto/auv/api/annotations/v1/annotations.proto");
  println!("cargo:rerun-if-changed=../../proto/auv/api/core/v1/run.proto");
  println!("cargo:rerun-if-changed=../../proto/auv/api/core/v1/runner.proto");
  println!("cargo:rerun-if-changed=../../proto/auv/api/runner/v1/runtime.proto");
