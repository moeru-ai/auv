...
| **S2** N-frame / durable tracks | Bounded sequence motion; `scan-tracks` wire | `hold` | [S9a](2026-07-10-auv-scan-s9a-nframe-adjacent-timeline-handoff.md) landed N-1 adjacent multi-segment timeline **builder** (`scan-timeline-v0` unchanged); **tracks wire not implemented**; motion remains helper proof only |
