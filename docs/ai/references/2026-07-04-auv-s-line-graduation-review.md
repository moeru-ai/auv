...
| **S2** N-frame / durable tracks | Bounded sequence motion; `scan-tracks` wire | `hold` | [S9a](2026-07-10-auv-scan-s9a-nframe-adjacent-timeline-handoff.md) N-1 timeline builder; [S9b](2026-07-10-auv-scan-s9b-adjacent-tracks-wire-handoff.md) **`scan-tracks-v0` wire landed proof** — **tracks substrate still `hold`** (no rollup / no scene consumer / no runtime / no identity continuity verdict); motion remains helper proof only |
| **S3** coverage ledger | Regions, freshness, negative evidence, completeness | `partial` | `coverage.rs` → `CoverageView` (in-memory default substrate); S8a `landed proof` for `scan-coverage-v0` wire/IO — [S8a](2026-07-07-auv-scan-s8a-coverage-wire-handoff.md); S8b scene consumer — [S8b](2026-07-08-auv-scan-s8b-scene-coverage-consumer-handoff.md); S8c invoke producer — [S8c](2026-07-09-auv-scan-s8c-coverage-producer-handoff.md); **S8d inspect durable read** — [S8d](2026-07-10-auv-scan-s8d-inspect-coverage-handoff.md); **fixture-first durable coverage chain (S8a–S8d) `landed proof`**; **S3 ledger substrate stage stays `partial`** until live/N-frame/durable product wires |
...
| --- | --- |
| Durable `scan-coverage-v0` + golden reader | S8a: wire/IO cluster `landed proof`; **S8 fixture-first durable coverage chain (S8a–S8d) `landed proof`** — see [S8d handoff](2026-07-10-auv-scan-s8d-inspect-coverage-handoff.md); **S3 ledger substrate stage stays `partial`** |
...
2. ~~**S3 durable `scan-coverage-v0`**~~ — **S8a–S8d:** fixture-first durable coverage chain has `landed proof` evidence — see [S8d handoff](2026-07-10-auv-scan-s8d-inspect-coverage-handoff.md); **S3 ledger substrate stage remains `partial`** (in-memory default; live/N-frame/product wires deferred).
