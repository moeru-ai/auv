...
`missing_evidence`, `observation_failed`, `ambiguous_association`, `ambiguous_reacquire`, `lost` — see [evaluator handoff](2026-07-02-auv-scan-s4-lifecycle-evaluator-handoff.md).
