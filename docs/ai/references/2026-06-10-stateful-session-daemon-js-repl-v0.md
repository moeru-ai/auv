...
- `docs/ai/references/2026-05-21-live-inspect-recording-design.md` records the
  inspect server write and live-stream precedent.
- `docs/ai/references/2026-05-25-auv-dream-architecture-rust-engineering.md`
  already calls for resource-style JS/REPL bindings and first-class
  device/session ownership.
- `docs/ai/references/2026-06-03-netease-cloud-music-domain-api-design.md`
