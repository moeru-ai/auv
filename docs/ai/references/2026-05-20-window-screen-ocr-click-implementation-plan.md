...
- `docs/ai/references/2026-05-20-window-screen-ocr-click-design.md`: design source for this plan.
...
- Modify: `docs/ai/references/2026-05-19-netease-cloud-music-fixed-layout-baseline.md`
...
In `docs/ai/references/2026-05-19-netease-cloud-music-fixed-layout-baseline.md`, add a note at the top:
...
```bash
git add recipes/macos/netease-cloud-music/play-visible-anchor.v0.json recipes/macos/netease-cloud-music/play-visible-anchor.cases.v0.json recipes/macos/netease-cloud-music/README.md docs/ai/references/2026-05-19-netease-cloud-music-fixed-layout-baseline.md
