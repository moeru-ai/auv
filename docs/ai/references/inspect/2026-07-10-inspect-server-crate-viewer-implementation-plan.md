...
```bash
rg "auv_cli::inspect_server|crate::inspect_server|pub mod inspect_server|src/inspect_server" src crates docs/ai/references/inspect/2026-07-10-inspect-server-crate-viewer-implementation-plan.md
```
...
- Modify: `docs/ai/references/inspect/2026-07-10-inspect-server-crate-viewer-implementation-plan.md`
...
```markdown
- [`2026-07-10-auv-inspect-server-crate-viewer-implementation-plan.md`](2026-07-10-inspect-server-crate-viewer-implementation-plan.md) — implementation plan for extracting `auv-inspect-server` and migrating the viewer to Vite/Vue/TypeScript
```
...
```bash
git add docs/ai/references/INDEX.md docs/ai/references/inspect/2026-07-10-inspect-server-crate-viewer-implementation-plan.md
