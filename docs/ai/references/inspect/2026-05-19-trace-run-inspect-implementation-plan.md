...
**Goal:** Implement the `v1alpha1` trace/run recording format, canonical run store, formatter-based inspect output, workflow-level run aggregation, and read-only inspect server described in `docs/ai/references/inspect/2026-05-19-trace-run-inspect-design.md`.
...
**Files:**
- Modify: `docs/ai/references/inspect/2026-05-19-trace-run-inspect-design.md`
...
`docs/ai/references/inspect/2026-05-19-trace-run-inspect-design.md` to match. Keep
`docs/TERMS_AND_CONCEPTS.md` aligned with implemented terms.

- [ ] **Step 6: Commit verification doc updates**

```bash
git add docs/ai/references/inspect/2026-05-19-trace-run-inspect-design.md docs/TERMS_AND_CONCEPTS.md
