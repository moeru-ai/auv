...
- Modify `docs/ai/references/2026-06-11-auv-cli-invoke-driver-console-design.md`: mark handler-first implementation landed and describe remaining typed-args follow-up.
...
**Files:**
- Modify: `docs/ai/references/2026-06-11-auv-cli-invoke-driver-console-design.md`
...
In `docs/ai/references/2026-06-11-auv-cli-invoke-driver-console-design.md`, change the handler-first target section from future tense to landed state for:
...
```bash
git add Cargo.toml crates/auv-cli-invoke crates/auv-cli-invoke-macros src/runtime.rs docs/ai/references/2026-06-11-auv-cli-invoke-driver-console-design.md docs/ai/references/2026-06-13-auv-cli-invoke-handler-first-plan.md docs/TERMS_AND_CONCEPTS.md
