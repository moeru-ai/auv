...
- `docs/ai/references/invoke-cli/2026-06-11-cli-invoke-driver-console-design.md`
...
```bash
git add src/invoke.rs docs/ai/references/invoke-cli/2026-06-11-cli-invoke-driver-console-implementation-plan.md
...
```bash
git add src/runtime.rs src/lib.rs src/main.rs src/scroll_scan/mod.rs src/app/tests.rs src/catalog.rs docs/ai/references/invoke-cli/2026-06-11-cli-invoke-driver-console-implementation-plan.md
...
```bash
git add Cargo.toml Cargo.lock crates/auv-driver crates/auv-cli-invoke src docs/ai/references/invoke-cli/2026-06-11-cli-invoke-driver-console-implementation-plan.md
