...
**Files:**
- Modify:
  `docs/ai/references/invoke-cli/2026-06-17-invoke-command-handler-binding-plan.md`
- Modify:
  `docs/ai/references/invoke-cli/2026-06-17-cli-invoke-metadata-routing-design.md`
- Create:
  `docs/ai/references/invoke-cli/2026-06-18-invoke-direct-command-implementations-handoff.md`
