...
Owner opens dedicated S slice with reference doc under `docs/ai/references/`; gate unrelated to [App Command Pack](2026-07-05-core-app-command-pack-gate.md) unless owner explicitly links them.
