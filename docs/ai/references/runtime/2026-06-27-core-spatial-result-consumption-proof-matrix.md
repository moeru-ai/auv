...
Graduation reviews:
`docs/ai/references/runtime/2026-06-27-core-a-query-readiness-graduation-review.md` (rows 66/68)
and Core-A2³ (rows 65/69/70a–70c). **Admissible does not mean recommended now**;
default remains **defer**.

¹ See graduation review
`docs/ai/references/runtime/2026-06-27-core-a-query-readiness-graduation-review.md`:
...
`docs/ai/references/apps/osu/2026-06-28-osu-wq1-witness-quality-evidence-design.md` and
`docs/ai/references/apps/osu/2026-06-27-osu-consumption-probe-evidence.md`
(WQ1 section). Default remains **defer** extraction.

³ Core-A2 second-vertical graduation review (2026-06-28, `main` @ `91577c5`):
[`2026-06-28-auv-core-a2-stage-quality-graduation-review.md`](2026-06-30-query-readiness-closeout.md)
...
[`2026-06-29-auv-core-a3-stage-status-triad-helper-design.md`](2026-06-30-query-readiness-closeout.md)
...
[`2026-06-29-auv-core-x1-third-vertical-scouting-design.md`](2026-06-29-core-third-vertical-scouting-design.md)
and
...
[`2026-06-29-auv-core-x2-balatro-consumption-probe-design.md`](../apps/balatro/2026-06-30-balatro-consumption-probe.md)
and
[`2026-06-29-auv-core-x2-balatro-consumption-probe-evidence.md`](../apps/balatro/2026-06-30-balatro-consumption-probe.md)
...
¹³ Core-A5b-query D1 query backend label contract (2026-06-30, `main`):
[`2026-06-30-auv-core-a5b-query-d1-query-backend-label-contract.md`](2026-06-30-query-readiness-closeout.md)
— docs-only **70a** contract: stable `snake_case` label vocabulary + `as_str`
wire discipline; donor enums retain local serde and manifest fields; **no**
extraction approved.

¹⁴ Core-A5b-query D2 falsifier graduation review (2026-06-30, `main`):
[`2026-06-30-auv-core-a5b-query-d2-falsifier-graduation-review.md`](2026-06-30-query-readiness-closeout.md)
— 70a falsifiers pass for review language; **F4** (no shared consumer) and
**F-nominal-abstraction** block D3 candidacy; **docs-only closeout**; verdict
column **unchanged**; extraction **defer** until owner explicitly approves D3.
...
- D1 froze the stage pattern:
  `docs/ai/references/runtime/2026-06-30-query-readiness-closeout.md`
