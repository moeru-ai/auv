...
Status: design-only MVP proof contract. **Core-X2 implementation:** [`2026-06-29-auv-core-x2-balatro-consumption-probe-design.md`](../apps/balatro/2026-06-30-balatro-consumption-probe.md).
...
Aligned with
[`2026-06-27-auv-core-spatial-result-consumption-pattern.md`](2026-06-30-query-readiness-closeout.md):
