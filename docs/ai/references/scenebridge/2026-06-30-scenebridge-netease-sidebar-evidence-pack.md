...
**Boundary:** [A2 boundary decision review](2026-06-30-scenebridge-closure.md)
...
| --- | --- | --- | --- |
| `app_bundle_id` | yes (app identity) | scan `app` context | ViewMemory key ([view-memory-v0](../view-memory/2026-05-29-view-parser-view-memory-v0.md)) |
| `scope_id` / `projection_id` | yes (surface namespace, **provisional**) | `netease.playlist_sidebar` in [view-memory-v0](../view-memory/2026-05-29-view-parser-view-memory-v0.md) / [ir-shapes-v0](../view-memory/2026-05-29-view-parser-ir-shapes-v0.md); shipped region name `playlist_sidebar` | ViewMemory scope |
...
| Gap | Evidence |
| --- | --- |
| ViewMemory not implemented | [view-memory-v0](../view-memory/2026-05-29-view-parser-view-memory-v0.md) spec; zero `auv-view::memory` Rust |
...
| Spec vs shipped gap | [spec-vs-pr9 triage §10](../view-memory/2026-05-29-view-parser-spec-vs-pr9-divergence-triage.md) |
...
- [A2 boundary decision review](2026-06-30-scenebridge-closure.md)
- [A1 design charter](2026-06-30-scenebridge-closure.md)
