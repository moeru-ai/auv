...
- No list filter / sort — **list filter shipped in [B2b](2026-06-30-scenebridge-inspect-list-filter.md)**
...
| Topic | Direction |
|-------|-----------|
| Cross-run compare | → [B2c deferred doc](2026-06-30-scenebridge-inspect-cross-run-compare-deferred.md) |
...
- `src/inspect_server_viewer.html` — diagnostic links, resolve-then-jump helpers
- `src/inspect_server/mod.rs` — `viewer_renders_view_parser_diagnostic_links_hooks`
- [B1 handoff](2026-06-30-scenebridge-inspect-viewer-consumption.md) (proof panel + list badges)
