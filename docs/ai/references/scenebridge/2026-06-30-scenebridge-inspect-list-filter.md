...
- `src/inspect_server_viewer.html` — filters, banner, self-test
- `src/inspect_server/mod.rs` — `viewer_renders_view_parser_list_filter_hooks`
- [B1 handoff](2026-06-30-scenebridge-inspect-viewer-consumption.md) (list badges + `view_parser_summary`)
- [B2a handoff](2026-06-30-scenebridge-inspect-diagnostic-links.md) (in-run diagnostic links)
