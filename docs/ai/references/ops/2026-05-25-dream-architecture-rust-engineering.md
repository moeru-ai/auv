...
`docs/ai/references/ops/2026-05-12-setup.md`, while preserving its core
...
- `docs/ai/references/ops/2026-05-25-projects-research-and-repl-api.md`
...
`docs/ai/references/ops/2026-05-12-setup.md` says schema fields should be
