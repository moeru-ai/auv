...
- [Core-A5b-prep backend label split review](2026-06-30-auv-core-a5b-prep-backend-label-discipline-split-review.md)
- [Core-A6 row 70 split owner decision](2026-06-30-auv-core-a6-row-70-split-owner-decision.md)
- [Core-A4 quality/backend falsifier gate](2026-06-29-auv-core-a4-quality-backend-helper-falsifier-gate.md)
...
**No extraction approved.** [Core-A6](2026-06-30-auv-core-a6-row-70-split-owner-decision.md)
...
| Note | Relationship |
| --- | --- |
| [A5b-prep](2026-06-30-auv-core-a5b-prep-backend-label-discipline-split-review.md) | Analytical three-way split; 70a query half evidence |
| [Core-A6](2026-06-30-auv-core-a6-row-70-split-owner-decision.md) | Owner row split; 70a helper-only admissible review language |
| [Core-A4](2026-06-29-auv-core-a4-quality-backend-helper-falsifier-gate.md) | Pre-split F2/F3 blockers; F4 open on shared consumer |
| [Proof matrix row 70a](2026-06-27-auv-core-spatial-result-consumption-proof-matrix.md) | Footnote **¹³** → this contract |
