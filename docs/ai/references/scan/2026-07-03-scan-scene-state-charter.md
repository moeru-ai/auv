...
| L3 | in-memory inspect projection | S6a (landed); charter旧称 S5b — see [S6a handoff](2026-07-03-scan-scene-state-reference.md); B-line/run_read bridge remains S6b candidate |
...
- [S-line substrate](2026-07-03-scan-streaming-observation-substrate.md)
- [S4 lifecycle charter](2026-07-03-scan-anchor-lifecycle-charter.md)
- [S5a handoff](2026-07-03-scan-scene-state-reference.md)
