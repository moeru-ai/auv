...
- Re-grade S-line against
  [`2026-07-03-s-line-streaming-observation-substrate.md`](2026-07-03-scan-streaming-observation-substrate.md)
...
- [`2026-07-03-s-line-streaming-observation-substrate.md`](2026-07-03-scan-streaming-observation-substrate.md)
- [`2026-07-02-auv-scan-s0-charter.md`](2026-07-02-scan-charter.md)
...
| **S2 minimal temporal** (motion, association, `scan-timeline-v0`) | **`helper proof only`** — wire/IO bounded boundary in [2026-07-05 bounded contract review](2026-07-05-scan-bounded-contract-graduation-review.md); motion semantics unchanged |
...
| --- | --- | --- | --- |
| **S0** charter & five questions | Vocabulary + auditable question set | `landed proof` (docs) | [S0 charter](2026-07-02-scan-charter.md); `SceneDraftAnswers` in `scene_state.rs` |
| **S1** frame binding & artifact | Versioned `scan-frame-v0`, round-trip, strict validation | `landed proof` | [slice1](2026-07-03-scan-temporal-core-landed.md)–[slice3](2026-07-03-scan-temporal-core-landed.md), [s4a](2026-07-03-scan-temporal-core-landed.md); `artifact.rs`, `frame.rs`, `producer/`, `reader.rs` |
...
| **S2** two-frame motion | Explicit estimate or `motion_unknown` | `landed proof` | `motion.rs`, `timeline.rs` ([s4b](2026-07-03-scan-temporal-core-landed.md)); metadata `window_bounds` delta — `scan-timeline-v0` wire/IO bounded language: [2026-07-05 review](2026-07-05-scan-bounded-contract-graduation-review.md) |
...
| **S2** N-frame / durable tracks | Bounded sequence motion; `scan-tracks` wire | `hold` | [S9a](2026-07-10-scan-timeline-tracks-reference.md) N-1 timeline builder; [S9b](2026-07-10-scan-timeline-tracks-reference.md) **`scan-tracks-v0` wire landed proof** — **tracks substrate still `hold`** (no rollup / no scene consumer / no runtime / no identity continuity verdict); motion remains helper proof only |
| **S3** coverage ledger | Regions, freshness, negative evidence, completeness | `partial` | `coverage.rs` → `CoverageView` (in-memory default substrate); S8a `landed proof` for `scan-coverage-v0` wire/IO — [S8a](2026-07-10-scan-coverage-reference.md); S8b scene consumer — [S8b](2026-07-10-scan-coverage-reference.md); S8c invoke producer — [S8c](2026-07-10-scan-coverage-reference.md); **S8d inspect durable read** — [S8d](2026-07-10-scan-coverage-reference.md); **fixture-first durable coverage chain (S8a–S8d) `landed proof`**; **S3 ledger substrate stage stays `partial`** until live/N-frame/durable product wires |
| **S4** anchor lifecycle | observed → stale → reacquired \| lost with evidence | `partial` | [lifecycle evaluator](2026-07-03-scan-temporal-core-landed.md); baked `lifecycle_events` — not hot-path derived |
| **S5** scene state product | Answer S0 five questions without re-running scanner | `partial` | [S5a handoff](2026-07-03-scan-scene-state-reference.md); `observations_by_frame` external to frame wire |
...
| **B-line bridge** | Consume summary product, not raw frame JSON | `partial` | [S6a](2026-07-03-scan-scene-state-reference.md), [S6b-1](2026-07-03-scan-scene-state-reference.md); no viewer |
| **M/G guardrail** | Optional cold-path only | `pass` | Zero game/SLAM coupling in S core |
| **Runtime invoke** | Implicit run recording writes scan artifacts | `hold` | S7 landed `scan.frame` (`scan-frame-v0` + `scan-frame-image` via fixture producer) — see [S7 handoff](2026-07-03-scan-temporal-core-landed.md); S8c landed `scan.coverage` (`scan-coverage-v0` via coverage fixture producer) — see [S8c handoff](2026-07-10-scan-coverage-reference.md); **evidence toward** `partial` bridge only; runtime producer lane **not** graduated (live capture, multi-frame, read-side gaps remain) |
...
| --- | --- | --- |
| [S0 charter](2026-07-02-scan-charter.md) | design charter | ✅ Accurate |
| [S1 temporal core plan](2026-07-03-scan-temporal-core-landed.md) | step 1 landed | ✅ Accurate |
| [S1 slice1 handoff](2026-07-03-scan-temporal-core-landed.md) | landed | ✅ Matches `scan-frame-v0` |
| [S1 slice2 handoff](2026-07-03-scan-temporal-core-landed.md) | landed | ✅ Matches `producer/` |
| [S1 slice3 handoff](2026-07-03-scan-temporal-core-landed.md) | implemented | ✅ Matches `reader.rs` |
| [S1 s4a handoff](2026-07-03-scan-temporal-core-landed.md) | landed | ✅ `two_frame_v0` fixture |
| [S1 s4b handoff](2026-07-03-scan-temporal-core-landed.md) | landed | ✅ `scan-timeline-v0` |
| [S4 lifecycle evaluator](2026-07-03-scan-temporal-core-landed.md) | landed | ✅ `lifecycle.rs` |
| [S4 charter](2026-07-03-scan-scene-state-reference.md) | docs-only | ✅ Accurate |
| [S5 charter](2026-07-03-scan-scene-state-reference.md) | docs-only | ✅ Accurate |
| [S5a handoff](2026-07-03-scan-scene-state-reference.md) | landed | ✅ `scene_state.rs` |
| [S6a handoff](2026-07-03-scan-scene-state-reference.md) | landed | ✅ `scene_state_inspect.rs` |
| [S6b-1 handoff](2026-07-03-scan-scene-state-reference.md) | landed | ✅ `scene_state_read.rs` |
| [S1 s2-s4 engineering plan](2026-07-03-scan-temporal-core-landed.md) | **was stale** (`not started`) | ⚠️ **Updated** — S1-2/3/4a/4b landed; see doc status line |
| [S1 s2-s4 GAN spec](2026-07-03-scan-temporal-core-landed.md) | rubric companion | ✅ Still valid as evaluation spec |
| [S-line substrate roadmap](2026-07-03-scan-streaming-observation-substrate.md) | direction note | ✅ Accurate target; not claiming completion |
...
| --- | --- |
| Durable `scan-coverage-v0` + golden reader | S8a: wire/IO cluster `landed proof`; **S8 fixture-first durable coverage chain (S8a–S8d) `landed proof`** — see [S8d handoff](2026-07-10-scan-coverage-reference.md); **S3 ledger substrate stage stays `partial`** |
...
1. **S1 wire gap closure** — Add minimal `quality_flags` / binding metadata to `scan-frame-v0` with golden migration, **or** add `NOTICE` deferrals at `ScanFrame` for each roadmap field intentionally omitted. Bounded contract boundary frozen in [`2026-07-05-auv-s1-bounded-contract-graduation-review.md`](2026-07-05-scan-bounded-contract-graduation-review.md).
2. ~~**S3 durable `scan-coverage-v0`**~~ — **S8a–S8d:** fixture-first durable coverage chain has `landed proof` evidence — see [S8d handoff](2026-07-10-scan-coverage-reference.md); **S3 ledger substrate stage remains `partial`** (in-memory default; live/N-frame/product wires deferred).
...
- [ ] Accept **`candidate for narrow contract graduation`** language for S1 cluster only (refined: **`graduate bounded`** frame + two-frame timeline wire in [2026-07-05 bounded contract review](2026-07-05-scan-bounded-contract-graduation-review.md))
...
- Graduation review pattern:
  [`2026-06-28-auv-core-a2-stage-quality-graduation-review.md`](../runtime/2026-06-30-query-readiness-closeout.md)
- A-line completion context:
  [`2026-06-30-auv-scenebridge-a8-proof-graduation.md`](../scenebridge/2026-06-30-scenebridge-closure.md)
