...
|-------|------|---------------|
| Scroll scan design | [2026-05-21-scroll-scan-design.md](../view-memory/2026-05-21-scroll-scan-design.md) | **Complementary donor** — observe → scroll → merge **page-level** evidence with stop policy; not cross-frame track association |
...
| SceneBridge | [A1 charter](../scenebridge/2026-06-30-scenebridge-closure.md), B1–B2c handoffs | **S3** — memory / reacquire / inspect consumption; do not mix rhythm in S0/S1 |
| Core lane roadmap | [2026-06-13-auv-core-lane-roadmap.md](../runtime/2026-06-13-core-roadmap.md) | S line follows core invoke + run recording model |
...
- New inspect server compare APIs (see [B2c deferred](../scenebridge/2026-06-30-scenebridge-inspect-cross-run-compare-deferred.md))
...
| **S1** | [2D temporal scan core plan](2026-07-03-scan-temporal-core-landed.md) | planned; blocked on S0 merge |
...
| Trigger | Unlocks |
|---------|---------|
| Owner names **S1 implementation** after S0 charter is merged | Execute [S1 plan](2026-07-03-scan-temporal-core-landed.md) slices — still requires per-slice owner approval |
| ≥2 Evidence records per [B2c-style gate](../scenebridge/2026-06-30-scenebridge-inspect-cross-run-compare-deferred.md) pattern | N/A for S0; listed so S3 does not reopen compare early |
...
- [Scroll scan design](../view-memory/2026-05-21-scroll-scan-design.md)
- [SceneBridge A1 charter](../scenebridge/2026-06-30-scenebridge-closure.md)
- [Core lane roadmap](../runtime/2026-06-13-core-roadmap.md)
