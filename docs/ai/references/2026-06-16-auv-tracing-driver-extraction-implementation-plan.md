...
- Modify: `docs/ai/references/2026-06-10-auv-tracing-driver-runtime-recording-split.md`
...
In `docs/ai/references/2026-06-10-auv-tracing-driver-runtime-recording-split.md`, change the status line to:
...
```bash
git add docs/TERMS_AND_CONCEPTS.md docs/ai/references/2026-06-10-auv-tracing-driver-runtime-recording-split.md docs/ai/references/2026-06-16-auv-tracing-driver-extraction-implementation-plan.md
