...
3. `docs/ai/references/ops/2026-05-24-structured-observation-roadmap.md`
4. `docs/ai/references/ops/2026-05-23-surface-selector-contract.md`
5. `docs/ai/references/view-memory/2026-05-21-scroll-scan-design.md`
6. `src/contract.rs`
...
Read:
- AGENTS.md
- docs/ai/references/recognition/2026-05-25-recognition-consumption-handoff.md
