# API-L1: Session API Operator Guide (archived)

> Historical operator guide. The current command, crate ownership, supported
> RPCs, and endpoint adapters are documented in
> [`2026-07-31-daemon-session-api-architecture.md`](2026-07-31-daemon-session-api-architecture.md).
> In particular, `GetOperation` and `StreamSessionEvents` are not present in
> the current protobuf contract.

**Date:** 2026-06-30
**Status:** operator reference — live entry, RPC boundaries, debugging
**Slice:** docs-only

**Pause context:** [API-P14](2026-06-30-session-api-closeout.md)
**Smoke:** [API-P13](2026-06-30-session-api-closeout.md), [API-S1](2026-06-30-session-api-closeout.md)
**Freeze pointers:** [R2](2026-06-30-session-api-closeout.md), [R2b-A](2026-06-30-session-api-closeout.md), [R2c-A](2026-06-30-session-api-closeout.md)
...
See [P13 handoff](2026-06-30-session-api-closeout.md) for the
...
- [P4 server seam](2026-06-30-api-session-proto-server-seam-design.md)
- [P12 identity closeout](2026-06-30-session-api-closeout.md)
