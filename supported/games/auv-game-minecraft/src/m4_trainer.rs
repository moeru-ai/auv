...
#![deprecated(note = "3DGS-as-memory line paused per 2026-09-25 closeout (sparse-view does not generalize). See docs/ai/references/3dgs/2026-09-25-slice-b-closeout.md. Do not build on this.")]
