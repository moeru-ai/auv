//! Local dual-backend comparison helpers for restored Minecraft 3DGS queries.
//!
//! This logic was formerly in the retired `auv-compare` crate. It stays local
//! here because current main no longer exposes that shared crate, and the only
//! live restored consumer is Minecraft 3DGS spatial-query selection.
