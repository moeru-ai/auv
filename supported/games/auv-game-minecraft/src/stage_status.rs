//! Local status for persisted Minecraft 3DGS semantic, witness, and quality stages.
//!
//! This used to live in the retired shared `auv-stage-status` crate. Keep it
//! crate-local after the supported-apps/games migration: the restored 3DGS lane is
//! the only current consumer, and reintroducing a workspace crate would widen this
//! branch beyond the main-update slice.
